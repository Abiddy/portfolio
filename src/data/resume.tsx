...
export const DATA = {
  ...
  contact: {
    email: "abidinouman@gmail.com",
    tel: "+123456789",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/Abiddy",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/noumanabidi/",
        icon: Icons.linkedin,
      ...
      Youtube: {
        name: "Youtube",
        url: "https://www.youtube.com/@noumaaaan",
        icon: Icons.youtube,
        navbar: true,
      },
      email: {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Worked with a dynamic startup team to develop enterprise-level features and components - Directly collaborated with product and operation teams to identify and address bottlenecks, driving optimal solutions and product enhancements - Independently led initiatives to revamp the platform's user interface using functional components in React, significantly improving user experience and simplifying functionality - Built and optimized backend services with Java and Spring Boot, enhancing system reliability  and implementing a robust error logging processes",
    },
    {
      ...
      description:
        "Designed, developed, and maintained accessible web applications to serve 30k+ students at CSUN, communicating with customers to implement and deploy requested features to existing applications - Improved accessibility on all user-facing applications, ensuring test-driven development using Rspec testing",
    },
  ],
  education: [
    {
      ...
      degree: "Masters in Science, Computer Engineering",
      logoUrl: "/csun.png",
      start: "2020",
      end: "2022",
    },
  ...
  projects: [
    {
      ...
      active: true,
      description:
        "Developing a new age food ordering app that aims to help splotlight the dishes offered my smaller and underrepresented restaurants across America",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
    ...
    {
      title: "Restaurant Revamp",
      href: "https://borjstar.framer.website/",
      dates: "June 2023 - Present",
      active: true,
      description:
        "Designing and developed Borjstarts official website",
      technologies: [
        "Next.js",
        "Typescript",
        "PostgreSQL",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/Abiddy/Roberts-Detailing",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
